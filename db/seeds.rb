...
Option.create(content: "Magical Law Enforcemen", question_id: 15, house_id: "1")
Option.create(content: "Curse Breaker", question_id: 15, house_id: "2")
Option.create(content: "Potioneer", question_id: 15, house_id: "3")
Option.create(content: "Healer", question_id: 15, house_id: "4")
